        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
            <div class="position-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(URL::to('client.annonces')); ?>">
                            Donneurs
                        </a>
                    </li>
                    <li class="nav-item">
...
</html><?php /**PATH C:\wamp64\www\bloodfinder\bloodfinder\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>