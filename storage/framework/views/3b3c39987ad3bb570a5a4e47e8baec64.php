...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center"  href="<?php echo e(URL::to('compte')); ?>">
            ...
            <li class="nav-item active">
                <a class="nav-link"  href="<?php echo e(URL::to('compte')); ?>">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo e(URL::to('bloodfinder-showdons2')); ?>">dons</a>
                        <a class="collapse-item" href="<?php echo e(URL::to('bloodfinder-showdemandes2')); ?>">demandes</a>
                    </div>
                </div>
            </li>
   ...
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           ...
           <div class="modal-footer">
               ...
               <a class="btn btn-primary"href="<?php echo e(URL::to('login')); ?>">Logout</a>
           </div>
       </div>
   </div>
</div>
    ...
    <script src="/frontend2/js/demo/chart-pie-demo.js"></script>

</body>

</html><?php /**PATH C:\wamp64\www\bloodfinder\resources\views/dashfinder/foot2.blade.php ENDPATH**/ ?>