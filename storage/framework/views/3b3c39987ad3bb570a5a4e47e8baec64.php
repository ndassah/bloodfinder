...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center"  href="<?php echo e(URL::to('bloodfinder-admin')); ?>">
            ...
            <li class="nav-item active">
                <a class="nav-link"  href="<?php echo e(URL::to('bloodfinder-admin')); ?>">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(URL::to('bloodfinder-admin-stat')); ?>">
