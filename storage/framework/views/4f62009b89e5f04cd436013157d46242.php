		...
		<div class="row">
			<div class="col-lg-7">
				<div class="cta-content">
					...
					<a href="<?php echo e(URL::to('publication2')); ?>" class="btn btn-main-2 btn-round-full">faire une demande<i class="icofont-simple-right  ml-2"></i></a>
				</div>
			</div>
		</div>
	</div>
...
<?php echo $__env->make('layout.foot3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bloodfinder\resources\views/client/service2.blade.php ENDPATH**/ ?>