		...
		<div class="row align-items-center">
			...
			<div class="col-lg-4">
				<div class="about-content pl-4 mt-4 mt-lg-0">
					...
					<a href="<?php echo e(URL::to('service')); ?>" class="btn btn-main-2 btn-round-full btn-icon">Services<i class="icofont-simple-right ml-3"></i></a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 col-md-10 " id="annonces">
				<div class="appoinment-wrap mt-5 mt-lg-0">
                    ...
                    <a class="btn btn-main btn-round-full" href="<?php echo e(URL::to('annonces')); ?>" >publier <i class="icofont-simple-right ml-2  "></i></a>
                </form>
            </div>
			</div>
		</div>
...
<?php echo $__env->make('layout.foot', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bloodfinder\bloodfinder\resources\views/client/index.blade.php ENDPATH**/ ?>