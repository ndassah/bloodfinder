			   ...
			   <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('about')); ?>">Apropos</a></li>		  
				  <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown03">
						...
						<li class="nav-item">
							<a href="<?php echo e(URL::to('publication')); ?>"  class="nav-link">faire un dons</a>
						</li>
					</ul>
			  	  </li>
					<li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('detailDonneur')); ?>">info compte</a></li>		  
