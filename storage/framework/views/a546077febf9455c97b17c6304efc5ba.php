			...
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<!--<div class="btn-container ">
						<a href="<?php echo e(URL::to('publication2')); ?>"  class="btn btn-main-2 btn-icon btn-round-full">faire une demande<i class="icofont-simple-right ml-2  "></i></a>
					</div>-->
				</div>
			</div>
		</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-4">
				<div class="about-content pl-4 mt-4 mt-lg-0">
					...
					<a href="<?php echo e(URL::to('service2')); ?>" class="btn btn-main-2 btn-round-full btn-icon">Services<i class="icofont-simple-right ml-3"></i></a>
				</div>
			</div>
		</div>
	</div>
...
<?php echo $__env->make('layout.foot3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bloodfinder\resources\views/client/index3.blade.php ENDPATH**/ ?>