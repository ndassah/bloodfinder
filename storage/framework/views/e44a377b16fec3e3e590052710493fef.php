         ...
         <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="contact-block mb-4 mb-lg-0">
                    ...
                    <h5>Email</h5>
                    <a href="mailto:mohamedtariq150@mail">mohamedtariq150@mail.com</a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="contact-block mb-4 mb-lg-0">
...
<?php echo $__env->make('layout.foot3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bloodfinder\resources\views/client/contact2.blade.php ENDPATH**/ ?>