		  ...
		  <div class="collapse navbar-collapse" id="navbarmain">
			<ul class="navbar-nav ml-auto">
			  <li class="nav-item active">
				<a class="nav-link" href="<?php echo e(URL::to('home')); ?>">Accueil</a>
			  </li>
			  <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('about3')); ?>">Apropos</a></li>
			  <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('contact3')); ?>" class="--primary">Contact</a></li>
			  <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('inscription')); ?>" class="--primary">Inscription</a></li>
			  <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('login')); ?>" class="--primary">login</a></li>
...
<footer class="footer section gray-bg">
   ...
   <?php /**PATH C:\wamp64\www\bloodfinder\resources\views/layout/foot0.blade.php ENDPATH**/ ?>