...
<header>
	...
	<nav class="navbar navbar-expand-lg navigation" id="navbar">
		<div class="container">
		 	 <a class="navbar-brand" href="<?php echo e(URL::to('indexHopitaux')); ?>">
		  ...
		  <div class="collapse navbar-collapse" id="navbarmain">
			<ul class="navbar-nav ml-auto">
			  <li class="nav-item active">
				<a class="nav-link" href="<?php echo e(URL::to('indexHopitaux')); ?>">Accueil</a>
			  </li>
			   <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('about2')); ?>">Apropos</a></li>
			   ...
			   <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown03">
						<li class="nav-item">
							<a class="nav-link" href="<?php echo e(URL::to('showdons')); ?>">voir les Dons</a>
						</li>
						<li class="nav-item">
							<a href="<?php echo e(URL::to('publication2')); ?>"  class="nav-link">faire une demande</a>
						</li>
					</ul>
			  	</li>
				  <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('detailHopital')); ?>">info compte</a></li>		  
			   <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('contact2')); ?>" class="--primary">Contact</a></li>
			   <li class="nav-item"><a href="<?php echo e(URL::to('home')); ?>" class="btn btn-main btn-round-full">Logout</a></li>
			</ul>
		  </div>
		</div>
	</nav>
...
<footer class="footer section gray-bg">
   ...
   <?php /**PATH C:\wamp64\www\bloodfinder\resources\views/layout/foot3.blade.php ENDPATH**/ ?>